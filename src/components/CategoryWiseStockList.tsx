...
export const CategoryWiseStockList = ({ products, onEdit }: CategoryWiseStockListProps) => {
              ...
              <table className="min-w-full border-collapse">
                <thead>
                  <tr className="bg-slate-50 border-b-2 border-slate-300">
                    ...
                    <th className="border border-slate-300 p-4 text-left text-slate-800 font-bold">Actions</th>
                  </tr>
                </thead>
                <tbody>
